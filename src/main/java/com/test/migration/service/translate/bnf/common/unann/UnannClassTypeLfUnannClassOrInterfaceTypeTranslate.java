...
import com.test.migration.service.translate.replace.UnannClassTypeLfUnannClassOrInterfaceTypeReplace;
...
public class UnannClassTypeLfUnannClassOrInterfaceTypeTranslate {
     ...
     * @return
     */
    public String translateUnannClassTypeLfUnannClassOrInterfaceType(ParserRuleContext ctx) {
        if (ctx == null || ctx.getRuleIndex() != Java8Parser.RULE_unannClassType_lf_unannClassOrInterfaceType) {
            Log.error("RULE_unannClassType_lf_unannClassOrInterfaceType error");
            return null;
        }
        ...
        UnannClassTypeLfUnannClassOrInterfaceTypeReplace replace = new UnannClassTypeLfUnannClassOrInterfaceTypeReplace();
