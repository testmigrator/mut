...
import com.test.migration.service.translate.bnf.common.primary.MethodReferenceLfnoPrimaryTranslate;
...
public class PrimaryNoNewArrayLfnoPrimaryLfnoArrayAccessLfnoPrimaryTranslate {
     ...
     * @return
     */
    public String translatePrimaryNoNewArray_lfno_primary_lfno_arrayAccess_lfno_primary(ParserRuleContext ctx) {
        if ((ctx == null) || (ctx.getRuleIndex() != Java8Parser.RULE_primaryNoNewArray_lfno_primary_lfno_arrayAccess_lfno_primary)) {
            Log.info("RULE_primaryNoNewArray_lfno_primary_lfno_arrayAccess_lfno_primary error");
            return null;
        }
        ...
        Log.error("translatePrimaryNoNewArray_lfno_primary_lfno_arrayAccess_lfno_primary error");
        return null;
    }
}
